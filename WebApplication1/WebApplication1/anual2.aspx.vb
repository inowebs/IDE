...
Public Class anual2
    ...
    Private Sub controlaAcceso()
        ...
        End If
        myCommand = New SqlCommand(q)
        Dim cuenta = ExecuteScalarFunction(myCommand)
        If (cuenta.Equals(0)) Then 'sin contratos pagados 
            'dr.Close()
            redir.Text = "1"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then  '1a vez    
            ...
            ejercicio.Value = Request.QueryString("ejercicio")
            idContrato.Value = Request.QueryString("contra")
            pl.Value = Request.QueryString("pl")
            Dim q


            q = "SELECT postpago FROM contratos WHERE id=" + idContrato.Value.ToString
            myCommand = New SqlCommand(q)
            Dim postpago = ExecuteScalarFunction(myCommand)
            If (postpago.Equals(True)) Then '
            ...
            Else
                ...
                End If
            End If
            encab.Text = "Declaración Anual: Ejercicio " + ejercicio.Value + Vcomple
    ...
    Private Sub cargaGrid()
        ...
        Using dr = ExecuteReaderFunction(myCommand)
            ...
            While dr.Read()
                ...
                Using dr2grid = ExecuteReaderFunction(myCommand2)
                    While dr2grid.Read()
                        Dim ideDetAnual = dr2grid("id")
                        Dim contrib As New TreeNode()
                        If dr2grid("razonSocial") <> "" Then
                            contrib.Text = dr2grid("razonSocial") + " , "
                        Else
                            contrib.Text = IIf(Not DBNull.Value.Equals(dr2grid("nombreFull")), dr2grid("nombreFull"), dr2grid("nombres") & " " & dr2grid("ap1") & " " & dr2grid("ap2")) + " , "
                        End If
                        contrib.Text = contrib.Text + "Excedente: " + FormatCurrency(dr2grid("exedente")) + " , "
                        If Not DBNull.Value.Equals(dr2grid("chqCajaMonto")) Then
                            contrib.Text = contrib.Text + "Cheques caja efectivo: " + FormatCurrency(dr2grid("chqCajaMonto")) + " , "
                        End If
                        ...
                        Using dr3 = ExecuteReaderFunction(myCommand2)
                            While dr3.Read()
                                ...
                                myCommand2 = New SqlCommand(q2)
                                Using dr4 = ExecuteReaderFunction(myCommand2)
                                    While dr4.Read()
    ...
    Private Sub limpiaAño()
        ...
        Else
            normalComplementaria.Text = "COMPLEMENTARIA"
            q = "SELECT TOP 1 numOper,fechaPresentacion FROM ideAnual WHERE ejercicio=" + ejercicio.Value.ToString + " and numOper<>'0' and idcliente=" + Session("GidCliente").ToString + " order by id desc"
            myCommand = New SqlCommand(q)
            Using dr = ExecuteReaderFunction(myCommand)
                dr.Read()
        ...
        If ejercicio.Value.ToString = "2008" Or ejercicio.Value.ToString = "2009" Then
    ...
    Private Sub cargaAño()
        ...
        Using dr2 = ExecuteReaderFunction(myCommand2)
            ...
            If estado.Text = "ACEPTADA" Or estado.Text = "CONTINGENCIA" Then 'no se puede editar
                ...
                myCommand4 = New SqlCommand(q)
                Using dr3 = ExecuteReaderFunction(myCommand4)
                    dr3.Read()
    ...
    Private Sub insertaAnualVacia()
        ...
        q = "INSERT INTO ideAnual(ejercicio,nOpers,impteExcedente,impteDeterminado,impteRecaudado,imptePendienteRecaudar,numOper,fechaPresentacion,normalComplementaria,idRepresentanteLegal,idIdeConf,idCliente,viaImportacion) VALUES('" + ejercicio.Value.ToString + "',0,0,0,0,0,'0','" + Now().ToString("yyyy-MM-dd") + "','" + normalComplementaria.Text + "'," + idRepresentanteLegal.Text.ToString + "," + idIdeConf.ToString + "," + Session("GidCliente").ToString + ",0)"
        myCommand3 = New SqlCommand(q)
        ExecuteNonQueryFunction(myCommand3)

        q = "SELECT TOP 1 id FROM ideAnual WHERE ejercicio='" + ejercicio.Value.ToString + "' and idCliente=" + Session("GidCliente").ToString + " order by id desc"
        myCommand4 = New SqlCommand(q)
        Using dr3 = ExecuteReaderFunction(myCommand4)
            dr3.Read()
            id.Text = dr3("id")
    ...
    Private Sub insertaMensualVacia()
        ...
        q = "SELECT id FROM reprLegal WHERE idCliente=" + Session("GidCliente").ToString + " and esActual=1"
        myCommand = New SqlCommand(q)
        idRepresentanteLegal.Text = ExecuteScalarFunction(myCommand)
    ...
    Protected Sub importMensXls_Click(ByVal sender As Object, ByVal e As EventArgs) Handles importMensXls.Click
        ...
        savePath += casfim + "-A-" + ejercicio.Value.ToString + "-" + tipo + "-" + Server.HtmlEncode(FileUpload1.FileName)
        h1.Value = savePath
        Try
    ...
    Private Sub creaTagsAnual()
        ...
        nomArchMens = "C:\SAT\" + casfim + "\" + casfim + "-A-" + ejercicio.Value.ToString + tipo + idArch + ".XML"
        ...
        If tipo = "N" Then
            archivo.WriteLine("                <Normal ejercicio='" + ejercicio.Value.ToString + "'></Normal>")
        Else
            archivo.WriteLine("                <Complementaria ejercicio='" + ejercicio.Value.ToString + "' opAnterior='" + numOperAnt.Text.Trim + "' fechaPresentacion='" + CDate(fechaPresentacionAnt.Text.Trim).ToString("yyyy-MM-dd") + "'></Complementaria>")
        End If
                    ...
                    Using dr4 = ExecuteReaderFunction(myCommand)
                        If dr4.HasRows Then
                            ...
                            While dr4.Read()
                                ...
                                myCommand = New SqlCommand("SELECT numeroCuenta FROM cotitularesCuentaAnual WHERE idideDetAnual =" + ideDetAnual.ToString) 'todos los #s cta
                                Using dr = ExecuteReaderFunction(myCommand)
                                    While dr.Read()
                                ...
                                If Not DBNull.Value.Equals(montoExcedente) Or Not DBNull.Value.Equals(cheque) Then
                                    ...
                                    End If
                                    myCommand = New SqlCommand("SELECT * FROM cotitularesCuentaAnual WHERE idideDetAnual =" + ideDetAnual.ToString + " and numeroCotitulares>0") 'solo #s cta con cotit > 0
                                    Using dr = ExecuteReaderFunction(myCommand)
                                        While dr.Read()
                                            ...
                                            myCommand2 = New SqlCommand("SELECT * FROM tcotitularAnual WHERE idCotitularesCuentaAnual =" + idCotitularesCuentaAnual.ToString)
                                            Using dr2 = ExecuteReaderFunction(myCommand2)
                                                While dr2.Read()
    ...
    Private Function validacion() As Boolean
        ...
        If ValidaXML(xDoc, errores) = False Then
            ...
            Using elcorreo
                ...
                elcorreo.Body = "<html><body>cliente=" + Session("curCorreo") + ", ejercicio=" + ejercicio.Value.ToString + ", error=" + errores + "</body></html>"
...
etqErr:
                If ctrlErr = 1 Then
                    estado.Text = "VACIA"
                    myCommand2 = New SqlCommand("UPDATE ideAnual SET estado='VACIA' WHERE id=" + id.Text)
        ...
        Try
            ...
            If array IsNot Nothing Then
                ...
                For ren As Integer = 6 To rens '1-5rens=encab 6o=datos
                    ...
                    If descrip = "CON" Then
                        q = "SELECT DISTINCT c.id, c.razonSocial FROM contribuyente c, ideAnual a, ideDetAnual idd WHERE c.rfc='" + rfc + "' and a.ejercicio='" + ejercicio.Value.ToString + "' and idd.idAnual=a.id and idd.idContribuyente=c.id and a.id=" + id.Text
                        myCommand = New SqlCommand(q)
                        Using dr = ExecuteReaderFunction(myCommand)
                            ...
                            Else    'nuevo registro
                                ...
                                Using dr2 = ExecuteReaderFunction(myCommand)
                                    If Not dr2.HasRows Then
                                        ...
                                        If nombreFullVal = 0 Then
                                            myCommand2 = New SqlCommand("INSERT INTO contribuyente(nombres,ap1,ap2,numSocioCliente,razonSocial,rfc,Dom,telefono1,telefono2,correo,curp) VALUES('" + nombres + "','" + ap1 + "','" + ap2 + "','" + numSocioCliente + "','" + razon + "','" + rfc + "','" + Dom + "','" + telefono1 + "','" + telefono2 + "','" + correo + "','" + curp + "')")
                                        Else
                                            myCommand2 = New SqlCommand("INSERT INTO contribuyente(nombreFull,numSocioCliente,razonSocial,rfc,Dom,telefono1,telefono2,correo,curp) VALUES('" + nombres + "','" + numSocioCliente + "','" + razon + "','" + rfc + "','" + Dom + "','" + telefono1 + "','" + telefono2 + "','" + correo + "','" + curp + "')")
                                        End If
                                        ExecuteNonQueryFunction(myCommand2)

                                        q = "SELECT TOP 1 id FROM contribuyente ORDER BY id DESC"
                                        myCommand = New SqlCommand(q)
                                        idContrib = ExecuteScalarFunction(myCommand)
                    ...
                    ElseIf descrip = "CTA" Then
                        ...
                        Using dr = ExecuteReaderFunction(myCommand)
                            If dr.Read() Then
                                ...
                                ExecuteNonQueryFunction(myCommand2)
                            Else
                                myCommand2 = New SqlCommand("INSERT INTO cotitularesCuentaAnual(numeroCuenta,numeroCotitulares,idideDetAnual) VALUES('" + ctaNum.ToString + "'," + ctaCotit.ToString + "," + ideDetAnualActual.ToString + ")")
                                ExecuteNonQueryFunction(myCommand2)
...
siguiente2:
    ...
    Protected Sub mod_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnMod.Click
        ...
        myCommand = New SqlCommand("UPDATE ideAnual SET guardadaUsuario=1 WHERE id=" + Session("GidAnual").ToString)
        ExecuteNonQueryFunction(myCommand)
    ...
    Private Sub enviarDeclaracion()
        ...
        If Not File.Exists(archivoLocal) Then
            ...
            Exit Sub
        End If
        Dim nomArchMens2 = "C:\SAT\" + casfim + "\" + casfim + "-A-" + ejercicio.Value.ToString + tipo + idArch + fechaHoraFmt + ".XML.ZIP"
        Dim nomArchMensSinPath2 = casfim + "-A-" + ejercicio.Value.ToString + tipo + idArch + fechaHoraFmt + ".XML.ZIP"
        ...
        If InStr(resultado, "Transmision Correcta") = 0 Then '
            ...
            myCommand2 = New SqlCommand("UPDATE ideAnual SET estado='ERROR_ENVIO' WHERE id=" + id.Text)
            ExecuteNonQueryFunction(myCommand2)
            ...
            Using elcorreo
                ...
                elcorreo.Body = "<html><body>cliente=" + Session("curCorreo") + ", ejercicio=" + ejercicio.Value.ToString + ", error=" + resultado + "</body></html>"
                elcorreo.IsBodyHtml = True
                elcorreo.Priority = System.Net.Mail.MailPriority.Normal
                Dim smpt As New System.Net.Mail.SmtpClient
                smpt.Host = "smtp.gmail.com"
        ...
        Else
            ...
            myCommand2 = New SqlCommand("UPDATE ideAnual SET estado='ACEPTADA', fechaEnvio='" + fechaEnvio.Text + "', acuseSolicitado=0, evidEnvio='" + resultado + "' WHERE id=" + id.Text)
            ExecuteNonQueryFunction(myCommand2)
    ...
    Private Function validaModificada()
        myCommand = New SqlCommand("SELECT guardadaUsuario FROM ideAnual WHERE id=" + Session("GidAnual").ToString)
        Using dr = ExecuteReaderFunction(myCommand)
            If dr.Read() Then
    ...
    Protected Sub enviarDeclaracionExcel_Click(ByVal sender As Object, ByVal e As EventArgs) Handles enviarDeclaracionExcel.Click
        ...
        If (Request.QueryString("op") = "0" And Request.QueryString("subop") = "1") Or (Request.QueryString("op") = "2" And Request.QueryString("subop") = "1") Then
            ...
            End If
            '0s
        ElseIf Request.QueryString("op") = "1" Or (Request.QueryString("op") = "2" And pl.Value = "CEROS") Then  '0s
        ...
        Dim contra
        Dim fechaDeclarar = Convert.ToDateTime(Trim("01/01/" + ejercicio.Value.ToString)).ToString("yyyy-MM-dd")
        If pl.Value.ToString = "PREMIUM" Then
            q = "SELECT periodoInicial, fechaFinal FROM contratos WHERE id=" + idContrato.Value.ToString
            myCommand = New SqlCommand(q)
            Using dr = ExecuteReaderFunction(myCommand)
                contra = dr.Read()
    ...
    Private Sub bajarAcuse()
        ...
        ElseIf CDate(qFechaEnvio).ToString("yyyy-MM-dd") >= "2021-01-01" Then
            nomArchMens = "C:\SAT\" + casfim + "\" + casfim + "-" + "A-" + ejercicio.Value.ToString + tipo + idArch + fechaHoraFmt + ".XML"
                    ...
                    If ((nulo = False And qAcuseSolicitado.Equals(False)) Or nulo = True) And DateDiff("h", CDate(qFechaEnvio), CDate(Now)) > 23 Then '24hrs
                        ...
                        Using elcorreo
                            ...
                            Try
                                ...
                                myCommand = New SqlCommand("UPDATE ideAnual SET acuseSolicitado=1 WHERE id=" + id.Text)
                                ExecuteNonQueryFunction(myCommand)
                            Catch ex As Exception
                ...
                Else
                    If acuSinCorr.Checked.Equals(False) Then
                        ...
                        Using elcorreo
                            elcorreo.From = New System.Net.Mail.MailAddress("declaracioneside@gmail.com")
                            elcorreo.To.Add(Session("curCorreo"))
                            elcorreo.Subject = "Acuses IDE, ejercicio " + ejercicio.Value.ToString + " de" + razonSoc
                            ...
                            Try
                                ...
                                myCommand = New SqlCommand("UPDATE ideAnual SET acuseDescargado=1 WHERE id=" + id.Text)
                                ExecuteNonQueryFunction(myCommand)
        ...
        Catch ex1 As Exception
            ...
            Using elcorreo
                elcorreo.From = New System.Net.Mail.MailAddress("declaracioneside@gmail.com")
                elcorreo.To.Add("declaracioneside@gmail.com")
                elcorreo.Subject = "Acuses IDE " + Session("curCorreo") + ", ejercicio " + ejercicio.Value.ToString
    ...
    Private Sub contingencia()
        ...
        Else
            ...
            idArch = id.Text
        End If
        ContNomArchMens = "C:\SAT\" + casfim + "\" + casfim + "-ContA-" + ejercicio.Value.ToString + tipo + idArch + ".XML.ZIP"
        ...
        Using elcorreo
            ...
            If quienContin.SelectedValue.Equals("Proveedor") Then
                elcorreo.To.Add("declaracioneside@gmail.com")
                elcorreo.Subject = "Contingencia IDE por el proveedor, ejercicio " + ejercicio.Value.ToString + " de " + razon + " (" + Session("curCorreo") + ")"
            Else 'contribuyente
                elcorreo.To.Add(Session("curCorreo"))
                elcorreo.Subject = "Contingencia IDE por el contribuyente, ejercicio " + ejercicio.Value.ToString + " de " + razon + " (" + Session("curCorreo") + ")"
            End If
        ...
        myCommand3 = New SqlCommand("UPDATE ideAnual SET estado='CONTINGENCIA' WHERE id=" + id.Text)
        ExecuteNonQueryFunction(myCommand3)
    End Sub
    ...
    Protected Sub Crear_Click(ByVal sender As Object, ByVal e As EventArgs) Handles Crear.Click
        ...
        estado.Text = "CREADA"
        myCommand2 = New SqlCommand("UPDATE ideAnual SET estado='CREADA', idContrato=" + idContrato.Value.ToString + ", nOpers=0, impteExcedente=0, impteCheque=0,normalComplementaria='" + normalComplementaria.Text + "' WHERE id=" + id.Text)
        ExecuteNonQueryFunction(myCommand2)
    End Sub
    ...
    Protected Sub importarXml_Click(ByVal sender As Object, ByVal e As EventArgs) Handles importarXml.Click
        ...
        myCommand2 = New SqlCommand("UPDATE ideAnual SET estado='IMPORTADA', idContrato=" + idContrato.Value.ToString + ", viaImportacion=2 WHERE id=" + id.Text)
        ExecuteNonQueryFunction(myCommand2)
    ...
    Protected Sub verXml_Click(ByVal sender As Object, ByVal e As EventArgs) Handles verXml.Click
        ...
        If File.Exists("C:\inetpub\wwwroot\xmlSubidos\" + Session("curCorreo") + "." + ejercicio.Value.ToString + ".xml.ZIP") Then
            File.Delete("C:\inetpub\wwwroot\xmlSubidos\" + Session("curCorreo") + "." + ejercicio.Value.ToString + ".xml.ZIP")
        End If
        'bajar de la BD
        Dim myCommand2 As New SqlCommand
        With myCommand2
            ...
            Using dr = ExecuteReaderFunction(myCommand2)
                If Not dr Is Nothing Then
                    If dr.Read Then
                        ...
                        End If
                        Dim writeStream As FileStream
                        writeStream = New FileStream("C:\inetpub\wwwroot\xmlSubidos\" + Session("curCorreo") + "." + ejercicio.Value.ToString + ".xml.ZIP", FileMode.Create)
                        Dim writeBinay As New BinaryWriter(writeStream)
                        writeBinay.Write(dr("archivoXML"))
                        writeBinay.Close()
                    End If
    ...
    Protected Sub consultarXml_Click(ByVal sender As Object, ByVal e As EventArgs) Handles consultarXml.Click
        ...
        Dim filename As String = Session("curCorreo") + "." + ejercicio.Value.ToString + ".xml.ZIP"
    ...
    Protected Sub export_Click(sender As Object, e As EventArgs) Handles export.Click
        ...
        End If
        Dim arch = Server.MapPath("~") + "exports/" + Session("curCorreo").ToString + ejercicio.Value.ToString + ".xlsx"
        ...
        Response.AddHeader("content-disposition", "attachment; filename=" + Session("curCorreo").ToString + ejercicio.Value.ToString + ".xlsx")
    ...
    Private Sub lost_Click(sender As Object, e As EventArgs) Handles lost.Click
        ...
        myCommand2 = New SqlCommand("UPDATE ideAnual SET lost=1, estado='ACEPTADA', idContrato=" + idContrato.Value.ToString + ", viaImportacion=1, guardadaUsuario=1, acuseSolicitado=0, fechaEnvio='" + fenvio.Text.Trim.Replace("_", " ").Remove(13, 1).Insert(13, ":").Remove(16, 1).Insert(16, ":") + "', evidEnvio='" + resul.Text + "' WHERE id=" + id.Text)
        ExecuteNonQueryFunction(myCommand2)

        If Request.QueryString("pl") <> "PREMIUM" Then
            myCommand = New SqlCommand("UPDATE contratos SET nDeclHechas=nDeclHechas-1 WHERE id=" + idContrato.Value.ToString)
            ExecuteNonQueryFunction(myCommand)
        End If
